#!/usr/bin/env python3
"""
Main paper figure: F1 scores for all 6 benchmarked models.
Grouped by agent (Biological / Technical / Experimental Design / Overall).
Source CSVs: reports_test_v2_{model}_nopride/sdrf_benchmark_detailed.csv
"""
...
plt.tight_layout()
out = BASE / "plots_all_models_f1.png"
